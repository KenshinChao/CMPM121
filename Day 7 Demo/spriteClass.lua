...
function SpriteClass:new()
  ...
  local onlyAnim = {
    {sprites = self.sprites[1], flipX = false}, 
      {sprites = self.sprites[1], flipX = true}
    }
...
function OctorokSprites:new()
    ...
    self.directionSprites = {
    [DIRECTIONS.UP] = {
      {sprite = self.sprites[1], flipX = false}, --todo: add flipY
      {sprite = self.sprites[2], flipX = false}
    },
    [DIRECTIONS.DOWN] = {
         {sprite = self.sprites[1], flipX = false},
